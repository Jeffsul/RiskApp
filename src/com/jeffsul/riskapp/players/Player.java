...
public class Player
{
	...
	public static int getLuckiness(int[] diceStats)
	{
		...
		int diff3V2 = (int)(2*(diceStats[W3V2] - RiskCalculator.W3V2*total3V2) - 2*(diceStats[L3V2] - (RiskCalculator.L3V2 / (1.0 - RiskCalculator.W3V2))*(total3V2-diceStats[W3V2])));
		int diff2V2 = (int)(2*(diceStats[W2V2] - RiskCalculator.W2V2*total2V2) - 2*(diceStats[L2V2] - (RiskCalculator.L2V2 / (1.0 - RiskCalculator.W2V2))*(total2V2-diceStats[W2V2])));
